...
static void display_enemy_sprite(global_t *global, e_obj_t *enemy)
{
    ...
    sfSprite_setTextureRect(E_DICT[E_ID]->sprite[E_FACING][E_FRAME], rect(0, 0, size.x, size.y));
    ...
    sfRenderWindow_drawSprite(GW, E_DICT[E_ID]->sprite[E_FACING][E_FRAME], NULL);
